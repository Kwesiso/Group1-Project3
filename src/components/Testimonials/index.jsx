          ...
          <TestimonialCardContainer>
            {testimonials.map((testimonial) => (
              <TestimonialCard key={testimonial.id}>
                <TestimonialHeader flexDirection="row">
                  <ProfilePic src={testimonial.picture} alt="profile-pic" />
                  <TestimonialHeader flexDirection="column">
                    <Name>{testimonial.name}</Name>
                    <JobTitle>{testimonial.position}</JobTitle>
                  </TestimonialHeader>
                </TestimonialHeader>
                ...
                <TestimonialFooter>
                  <CompanyLogo src={testimonial.logo} alt="company-logo" />
                </TestimonialFooter>
              </TestimonialCard>
            ))}
            {/* <ArrowContainer>
